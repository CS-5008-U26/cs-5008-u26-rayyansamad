/* bubblesort.c
 * Bubble sort implementation using sorttemplate.c as a base
 * Sorts by repeatedly exchanging adjacent elements that are out of order
 * Stops early if a full pass has no exchanges
 */
...
// runs passes over the array exchanging adjacent elements that are out of order
// exits early if a full pass has zero exchanges (already sorted)
