/* roman.c
 * Accepts an integer from 1 to 4000 and prints it as a Roman numeral.
 * Uses the standard subtractive form (e.g. IV, IX, XL, etc.)
 *
 * Roman numeral values used:
...
int main() {
    ...
    /* repeatedly subtract the largest Roman value that fits,
       printing the symbol each time */
